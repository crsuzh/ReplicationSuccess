test_that("Output of function 'levelSceptical' stays the same.", {
    ...
    res <- list(
        ...
        c(1e-06, 0.005, 0.01, 0.05, 0.1, 0.5, 0.999),
        c(0.00054236461776295, 0.0471586461502341,
          0.0685481459365029, 0.165776272895704, 0.24479414365335,
          0.633407499183923, 0.999292893126253),
        c(0.000388053167217319, 0.0342740729682515, 0.0499873434217022,
          0.122397071826675, 0.182416641392926, 0.5, 0.98556013004208),
        c(0.000120273342410185, 0.0273312878015435, 0.0428682107732366,
          0.123358558704367, 0.195975110892562, 0.595937883003954,
          0.999213848543629),
