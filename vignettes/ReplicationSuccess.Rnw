...
prediction interval is in fact equivalent to conducting a meta-analytic $Q$-test 
...
preferred, since it tells quantitatively how compatible the estimates. In contrast,
