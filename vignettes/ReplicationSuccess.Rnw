...
distribution of the estimates are is well approximated by a normal distribution.
...
also see \citet{Held2020} and \citet{Held_etal2020} for technical details.
...
uncertainty due to between-study heterogeneity. For example,
