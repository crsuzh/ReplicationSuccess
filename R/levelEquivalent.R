...
#' the alternative.
#' @param dinf The limiting relative effect size bound below which
#' replication success is
...
#' @return Equivalent thresholds for the sceptical p-value corresponding
#' to \code{dmin}=1.
#' Thus, at the equivalent threshold, replication success is impossible for
#' borderline significant original
#' studies and shrinkage of the replication effect estimate.
#' @references Held, L. (2020). A new standard for the analysis and design
#' of replication studies (with discussion).
