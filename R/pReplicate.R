...
#'
#' @param po Numeric vector of p-values from the original study,
#' default is \code{NULL}.
#' @param zo Numeric vector of z-values from the original study.
#' Is calculated from \code{po}, if necessary.
#' @param c The ratio of the variances of the original and replication
#' effect estimates.
...
#' estimate in the same direction as in the original study.
#' @details This extends the statistic p_rep ("the probability of
#' replicating an effect")
#' by Killeen (2005) to the case of possibly unequal sample sizes,
#' see also Senn (2002).
#' @references
#' Killeen, P. R. (2005). An alternative to null-hypothesis significance
#' tests. \emph{Psychological Science}, \bold{16}, 345--353.
