#' Q-test to assess compatibility between original and
...
#' @param seo Numeric vector of standard errors of the original effect
#' estimates.
#' @param ser Numeric vector of standard errors of the replication effect
#' estimates.
#' @return p-value from Q-test.
#' @details This function computes the p-value from a meta-analytic Q-test
#' assessing compatibility between original and replication effect estimate.
#' Rejecting compatibility when the p-value is smaller than alpha is equivalent
#' with rejecting compatibility based on a (1 - alpha) prediction interval.
#' @references
